            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  disabled={loading}
                />
                {errors.first_name && <div className="mt-1 text-sm text-red-600">{errors.first_name}</div>}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  disabled={loading}
                />
                {errors.last_name && <div className="mt-1 text-sm text-red-600">{errors.last_name}</div>}
              </div>
            </div>
